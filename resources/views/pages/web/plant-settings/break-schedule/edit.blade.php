...
@section('body')
    <main>
        <div class="container pt-4">
            ...
            <hr>
            <form method="post" action="{{ route('settings.break-schedule.update', [$plant->uid, $break->id]) }}">
                @method('PUT')
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-12 mt-3">
                                        <label for="name" class="form-label">SCHEDULE NAME <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            value="{{ old('name') ? old('name') : $break->name }}"
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="1">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                {{-- canvas --}}
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="1-break-chart"></canvas>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-action me-2 submit_data btn-warna"><i class="fa fa-save"></i> SAVE</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-addrow" id="1"
                                        onclick="add_row(this);"><i class="fa fa-plus"></i> Add Row</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="2">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="2-break-chart"></canvas>
                                    </div>
                                </div>
                                {{-- table add start and end time --}}
                                <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-action me-2 submit_data btn-warna" ><i class="fa fa-save"></i> SAVE</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-addrow" id="2"
                                        onclick="add_row(this);"><i class="fa fa-plus"></i> Add Row</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="3">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="3-break-chart"></canvas>
                                    </div>
                                </div>
                                {{-- table add start and end time --}}
                                <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-action me-2 submit_data btn-warna"><i class="fa fa-save"></i> SAVE</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-addrow" id="3"
                                        onclick="add_row(this);"><i class="fa fa-plus"></i> Add Row</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="4">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="4-break-chart"></canvas>
                                    </div>
                                </div>
                                {{-- table add start and end time --}}
                                <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-action me-2 submit_data btn-warna"><i class="fa fa-save"></i> SAVE</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-addrow" id="4"
                                        onclick="add_row(this);"><i class="fa fa-plus"></i> Add Row</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="5">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="5-break-chart"></canvas>
                                    </div>
                                </div>
                                {{-- table add start and end time --}}
                                <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-action me-2 submit_data btn-warna"><i class="fa fa-save"></i> SAVE</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-addrow" id="5"
                                        onclick="add_row(this);"><i class="fa fa-plus"></i> Add Row</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="6">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="6-break-chart"></canvas>
                                    </div>
                                </div>
                                {{-- table add start and end time --}}
                                <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-action me-2 submit_data btn-warna"><i class="fa fa-save"></i> SAVE</button>
                                    <button type="button" class="btn btn-primary btn-sm btn-addrow" id="6"
                                        onclick="add_row(this);"><i class="fa fa-plus"></i> Add Row</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 data-schedule-cell" data-dow="7">
                        ...
                        <div class="card h-100">
                            <div class="card-body mt-1">
                                ...
                                <div class="row p-3">
                                    <div class="col" style="position: relative; height: 70px">
                                        <canvas id="7-break-chart"></canvas>
                                    </div>
                                </div>
                                {{-- table add start and end time --}}
                                <div class="table-responsive">
                    ...
                    <div class="text-end mt-3">
                        <a href="{{ route('settings.break-schedule.index',[ $plant->uid ]) }}" class="btn btn-secondary">BACK</a>
                    </div>
                </div>
            </form>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        function add_row(e) {
            ...
            var row_html = $('<tr id="' + row_id + '" >' +
                '<td>' + row_id + '</td>' +
                '<td><input type="text" id="start_time" class="form-control clock-picker" value="00:00"></td>' +
                '<td><input type="text" id="end_time" class="form-control clock-picker" value="00:00"></td>' +
                '<td class="text-center"><button type="button" class="btn btn-danger btn-sm" id="' + table_id +
                '" onclick="remove_row(this);"><i class="fa fa-trash"></i></button></td>' +
                '</tr>');
            ...
            row_html.find('input').clockTimePicker({
                required:true,
            });
        }
        ...
        $(document).ready(function() {
            var schedule_data = {!! json_encode($schedule_data) !!};
            ...
            if (schedule_data != null) {
                ...
                old_data.forEach(function(data) {
                    data.forEach(function(data_row, index) {
                        ...
                        var row_html = $('<tr id="' + row_id + '" >' +
                            '<td>' + row_id + '</td>' +
                            '<td><input type="text" id="start_time" class="form-control clock-picker" value="' +
                            start_time + '"></td>' +
                            '<td><input type="text" id="end_time" class="form-control clock-picker" value="' +
                            end_time + '"></td>' +
                            '<td class="text-center"><button type="button" class="btn btn-danger btn-sm" id="' +
                            table_id +
                            '" onclick="remove_row(this);"><i class="fa fa-trash"></i></button></td>' +
                            '</tr>');
                        $('#' + table_id + '-content').append(row_html);
    ...
    {{-- fakhrul --}}
    <script>
        var breakChartData = {!! json_encode($breakChartData) !!};

        console.log(breakChartData);
        var breakCharts = [];
        $(document).ready(function() {
            if (breakChartData) {
                breakChartData.forEach(function(data) {
                    constructBreakChart(data);
                });
            }

        });

        function constructBreakChart(data) {
            var ctx = document.getElementById(data.day_of_week + '-break-chart').getContext('2d');
            var config = config_chart(data.chart_data.break, data.chart_data.remainder);
            var new_chart = new Chart(ctx, config);
            breakCharts.push(new_chart);
        }

        function config_chart(break_data, remainder_data) {
            var config = {
                type: 'line',
                data: {
                    labels: [],
                    datasets: [{
                        label: 'Break Schedules',
                ...
                options: {
                    ...
                    animations: {
                        y: {
                            ...
                            from: (ctx) => {
                                if (ctx.type === 'default' && !ctx.dropped) {
                                    ctx.dropped = true;
                                    return 0;
                                }
                            }
