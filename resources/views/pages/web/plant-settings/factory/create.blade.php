...
<main>
    <div class="container pt-4">
        ...
        @yield('mobile-title')
        @yield('tab-nav-bar')
        <h5 class="secondary-text mt-4" style="text-transform: uppercase">ADD NEW FACTORY</h5>
        <hr>
        <form method="post" action="{{ route('settings.factory.store',[ $plant->uid ]) }}">
            @csrf
            <div class="mt-3">
                <!-- Data Form -->
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-md-12 mt-3">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Factory Name" required>

                            </div>
                            <div class="col-12 col-md-12 mt-3">
                                <label for="uid" class="form-label">FACTORY UID <span class="text-danger">*</span></label>
                                <input type="text" name="uid" id="uid" class="form-control" placeholder="Factory UID" value="{{ old('type') }}" required>
                                @error('uid')
