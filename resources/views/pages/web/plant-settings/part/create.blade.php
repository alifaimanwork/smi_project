...
<main>
    <div class="container pt-4">
        ...
        @yield('tab-nav-bar')
        <h5 class="secondary-text mt-3">CREATE PART</h5>
        <hr>
        <form method="post" action="{{ route('settings.part.store',[ $plant->uid ]) }}">
            @csrf
            <div class="row px-3">
                <!-- Data Form -->
                {{-- part information --}}
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <input type="text" name="part_no" class="form-control @error('part_no') is-invalid @enderror" id="part_no" placeholder="PART NUMBER" value="{{ old('part_no') }}" required>
                                    @error('part_no')
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <input type="text" name="part_name" class="form-control @error('part_name') is-invalid @enderror" id="part_name" placeholder="PART NAME" value="{{ old('part_name') }}" required>
                                    @error('part_name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                {{-- setup time --}}
                                <div class="col-12 col-md-6 mt-3">
                                    <label for="setup_time" class="form-label">SETUP TIME <span class="text-danger">*</span></label>
                                    <input type="text" name="setup_time" class="form-control @error('setup_time') is-invalid @enderror" id="setup_time" placeholder="SETUP TIME (IN SECONDS)" value="{{ old('setup_time') }}" required>
                                    @error('setup_time')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                {{-- cycle time --}}
                                <div class="col-12 col-md-6 mt-3">
                                    <label for="cycle_time" class="form-label">CYCLE TIME <span class="text-danger">*</span></label>
                                    <input type="text" name="cycle_time" class="form-control @error('cycle_time') is-invalid @enderror" id="cycle_time" placeholder="CYCLE TIME (IN SECONDS)" value="{{ old('cycle_time') }}" required>
                                    @error('cycle_time')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <input type="number" min="0" name="packaging" class="form-control @error('packaging') is-invalid @enderror" id="packaging" placeholder="PACKAGING" value="{{ old('packaging') }}" required>
                                    @error('packaging')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <input type="number" min="0" max="100" name="reject_target" class="form-control" id="reject_target" placeholder="REJECT TARGET (%)" value="{{ old('reject_target', 5)}}" required>
                                    @error('reject_target')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <select name="work_center" id="work_center" onclick="updateLineList()" onchange="updateLineList()" class="form-select" required>
                                        @if(!old('work_center'))
                                        ...
                                        @else
                                            @foreach ($workCenters as $workCenter)
                                                <option value="{{ $workCenter->id }}" {{ old('work_center') == $workCenter->id ? 'selected' : '' }}>{{ $workCenter->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <select name="line_number" id="line_number" class="form-select" required>
                                        @if(old('line_number'))
                                            <option value="{{ old('line_number') }}" selected>{{ old('line_number') }}</option>
                                        @endif
                                    </select>
                                </div>
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    {{-- <input type="text" list="datalistSide" name="side" class="form-control @error('side') is-invalid @enderror" id="side" placeholder="SIDE" value="{{ old('side')}}" required>
                                    <datalist id="datalistSide">
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" name="opc_part_id" class="form-control @error('opc_part_id') is-invalid @enderror" id="opc_part_id" placeholder="OPC PART ID" value="{{ old('opc_part_id')}}" required>
                                    @error('opc_part_id')
                                        <div class="text-danger">{{ $message }}</div>                                
                                    @enderror
                                </div>
