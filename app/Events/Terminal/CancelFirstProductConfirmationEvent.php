...
class CancelFirstProductConfirmationEvent implements ActivityLogEvent
{
    ...
    {
        return 'terminal.cancel-first-product-confirmation';
    }
    ...
    public function generateActivityLog(): ActivityLog
    {
        ...
        return new ActivityLog(
            [
                ...
                'event_title' => 'Cancel First Product Confirmation',
