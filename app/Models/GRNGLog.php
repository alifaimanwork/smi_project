 ...
 */
class GRNGLog extends ExportableLogModel
{

    const TABLE_NAME = 'gr_ng_logs';
    ...
    public function updateData()
    {
        ...
        $this->data = [
            ...
            'quantity' => $productionLine->reject_count,
        ...
        $this->file_name = "GRNG" . $dtNow->format('dmYHi') . $workCenterName . $lineNumber;


        //export path
        $this->export_path = $workCenter->gr_ng_destination;
