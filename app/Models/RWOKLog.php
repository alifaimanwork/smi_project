 ...
 */
class RWOKLog extends ExportableLogModel
{

    const TABLE_NAME = 'rw_ok_logs';
    ...
    public function updateData($count)
    {
        ...
        $this->data = [
            ...
            'document_header_text' => 'Rework-OK',
        ...
        $this->file_name = "RWOK" . $dtNow->format('dmYHi') . $workCenterName . $lineNumber;


        //export path
        $this->export_path = $workCenter->rw_ok_destination;
