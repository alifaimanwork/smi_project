 ...
 */
class RWNGLog extends ExportableLogModel
{

    const TABLE_NAME = 'rw_ng_logs';
    ...
    public function updateData($count)
    {
        ...
        $this->data = [
            ...
            'posting_date' => $production->stopped_at->format('dmY'),
            'document_header_text' => 'Rework-NG',
        ...
        $this->file_name = "RWNG" . $dtNow->format('dmYHi') . $workCenterName . $lineNumber;


        //export path
        $this->export_path = $workCenter->rw_ng_destination;
